#!/bin/bash
# Nginx + Next.js 启动脚本
# Nginx 反向代理监听 5000 端口，将 /ekp/* 代理到 EKP
# Next.js 运行在 5001 端口
...
# 启动 Next.js（后台运行）
echo "[4/4] 启动 Next.js 服务..."
cd "${COZE_WORKSPACE_PATH}"
PORT=${NEXTJS_PORT} pnpm start &
NEXTJS_PID=$!
...
echo "  - EKP 代理: http://localhost:${NGINX_PORT}/ekp/"
