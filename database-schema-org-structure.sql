...
('ekp-001', 'ekp.workflow.todo.list', '查询待办列表', '查询当前用户的待办事项列表', 'workflow', '/api/sys-notify/sysNotifyTodoRestService/getTodo', 'POST', 1, JSON_OBJECT('params', JSON_ARRAY('todoType'))),
('ekp-002', 'ekp.workflow.todo.detail', '查询待办详情', '查询单个待办事项的详细信息', 'workflow', '/api/workflow/todo/detail', 'GET', 1, JSON_OBJECT('params', JSON_ARRAY('todoId'))),
('ekp-003', 'ekp.workflow.todo.approve', '审批同意', '同意当前待办事项', 'workflow', '/api/workflow/approve', 'POST', 1, JSON_OBJECT('params', JSON_ARRAY('todoId', 'comment'))),
('ekp-004', 'ekp.workflow.todo.reject', '审批拒绝', '拒绝当前待办事项', 'workflow', '/api/workflow/reject', 'POST', 1, JSON_OBJECT('params', JSON_ARRAY('todoId', 'comment'))),
('ekp-005', 'ekp.workflow.process.start', '发起流程', '发起新的审批流程', 'workflow', '/api/workflow/process/start', 'POST', 1, JSON_OBJECT('params', JSON_ARRAY('processId', 'formData'))),
('ekp-006', 'ekp.workflow.process.list', '查询流程列表', '查询用户的流程列表', 'workflow', '/api/workflow/process/list', 'GET', 1, JSON_OBJECT('params', JSON_ARRAY('status'))),
('ekp-007', 'ekp.workflow.process.detail', '查询流程详情', '查询单个流程的详细信息', 'workflow', '/api/workflow/process/detail', 'GET', 1, JSON_OBJECT('params', JSON_ARRAY('processId'))),
('ekp-008', 'ekp.workflow.process.history', '查询流程历史', '查询流程的历史记录', 'workflow', '/api/workflow/process/history', 'GET', 1, JSON_OBJECT('params', JSON_ARRAY('processId'))),
('ekp-009', 'ekp.form.list', '查询表单列表', '查询可用的表单列表', 'form', '/api/form/list', 'GET', 1, JSON_OBJECT('params', JSON_ARRAY('category'))),
('ekp-010', 'ekp.form.detail', '查询表单详情', '查询单个表单的详细信息', 'form', '/api/form/detail', 'GET', 1, JSON_OBJECT('params', JSON_ARRAY('formId'))),
('ekp-011', 'ekp.form.data.query', '查询表单数据', '查询表单数据', 'form', '/api/form/data/query', 'GET', 1, JSON_OBJECT('params', JSON_ARRAY('formId', 'filters'))),
('ekp-012', 'ekp.form.data.create', '创建表单数据', '创建新的表单数据', 'form', '/api/form/data/create', 'POST', 1, JSON_OBJECT('params', JSON_ARRAY('formId', 'formData'))),
('ekp-013', 'ekp.form.data.update', '更新表单数据', '更新已有的表单数据', 'form', '/api/form/data/update', 'POST', 1, JSON_OBJECT('params', JSON_ARRAY('dataId', 'formData'))),
('ekp-014', 'ekp.meeting.list', '查询会议列表', '查询会议列表', 'meeting', '/api/meeting/list', 'GET', 1, JSON_OBJECT('params', JSON_ARRAY('startDate', 'endDate'))),
('ekp-015', 'ekp.meeting.detail', '查询会议详情', '查询单个会议的详细信息', 'meeting', '/api/meeting/detail', 'GET', 1, JSON_OBJECT('params', JSON_ARRAY('meetingId'))),
('ekp-016', 'ekp.meeting.create', '创建会议', '创建新会议', 'meeting', '/api/meeting/create', 'POST', 1, JSON_OBJECT('params', JSON_ARRAY('title', 'startTime', 'endTime', 'participants'))),
('ekp-017', 'ekp.meeting.update', '更新会议', '更新会议信息', 'meeting', '/api/meeting/update', 'POST', 1, JSON_OBJECT('params', JSON_ARRAY('meetingId', 'meetingData'))),
('ekp-018', 'ekp.meeting.cancel', '取消会议', '取消会议', 'meeting', '/api/meeting/cancel', 'POST', 1, JSON_OBJECT('params', JSON_ARRAY('meetingId'))),
